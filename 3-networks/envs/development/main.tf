...
locals {
  ...
  base_private_service_cidr = "10.210.192.0/21"
  base_subnet_primary_ranges = {
    (var.default_region1) = "10.210.16.0/21"
    (var.default_region2) = "10.210.80.0/21"
  }
  ...
  restricted_private_service_cidr = "10.211.192.0/21"
  restricted_subnet_primary_ranges = {
    (var.default_region1) = "10.211.16.0/21"
    (var.default_region2) = "10.211.80.0/21"
  }
