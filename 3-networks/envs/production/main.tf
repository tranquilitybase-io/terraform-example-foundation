...
locals {
   ...
   * Base network ranges
   */
  base_subnet_aggregates    = ["10.210.0.0/18", "10.210.64.0/18", "100.64.0.0/16", "100.65.0.0/16"]
  base_hub_subnet_ranges    = ["10.210.0.0/24", "10.210.64.0/24"]
  base_private_service_cidr = "10.210.224.0/21"
  base_subnet_primary_ranges = {
    (var.default_region1) = "10.210.48.0/21"
    (var.default_region2) = "10.210.112.0/21"
  }
   ...
   */
  restricted_subnet_aggregates    = ["10.211.0.0/18", "10.211.64.0/18", "100.72.0.0/16", "100.73.0.0/16"]
  restricted_hub_subnet_ranges    = ["10.211.0.0/24", "10.211.64.0/24"]
  restricted_private_service_cidr = "10.211.224.0/21"
  restricted_subnet_primary_ranges = {
    (var.default_region1) = "10.211.48.0/21"
    (var.default_region2) = "10.211.112.0/21"
  }
