...
locals {
  ...
  base_private_service_cidr = "10.210.208.0/21"
  base_subnet_primary_ranges = {
    (var.default_region1) = "10.210.32.0/21"
    (var.default_region2) = "10.210.96.0/21"
  }
  ...
  restricted_private_service_cidr = "10.211.208.0/21"
  restricted_subnet_primary_ranges = {
    (var.default_region1) = "10.211.32.0/21"
    (var.default_region2) = "10.211.96.0/21"
  }
